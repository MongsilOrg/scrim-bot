...
class Settings:
    ...
    TEAM_ASSIGNMENT_CHANNEL_ID: int = 1212383364258992128
    AUTO_ASSIGNMENT_START_CHANNEL_ID: int = 1390999095962767380
    TEAM_LIST_CHANNEL_ID: int = 1390999095962767380  # 조별 팀 목록 전송 채널
    BACKUP_ANALYSIS_CHANNEL_ID: int = 1400785133489098842
    
    # 조별 채널 ID
    GROUP_CHANNEL_IDS = {
        'A': 1337238342730776668,
        'B': 1337238366667669595,
        'C': 1337238442605543455,
        'D': 1337238460905553951,
        'E': 1337238477879906397,
        'F': 1337238497408585779
    }
